<template>
  <div class="p-8">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Заявки клиентов</h1>
...
const startWork = (requestId: string) => {
  requestsStore.updateRequestStatus(requestId, 'in_progress')
}
</script>
